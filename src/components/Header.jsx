        ...
        <div className="flex flex-row gap-4 items-center justify-between lg:mb-0">
              ...
              categories?.map((category) => {
                return (
                  <Link
                    ...
                    className={`uppercase cursor-pointer text-white font-semibold text-sm ${
                      id && id == category.id && "border-b-2"
                    }`}
                    key={category.id}
                  >
                    {category.name}
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              {/* amount */}
              <p className="bg-secondary text-black absolute w-[18px] h-[18px] rounded-full top-3 -right-1 text-[13px] flex justify-center items-center font-bold tracking-[-0.1em]">
                {itemsAmount}
              </p>
            </button>
            ...
            {!auth?.email ? (
              ...
              <div className="relative">
                ...
                >
                  <HiMenu className="text-primary text-xl" />
          ...
          <div
            ...
            } bg-white shadow-xl fixed top-0 bottom-0 w-full z-50 md:max-w-[500px] transition-all duration-300`}
          >
            <Cart />
          </div>
        </div>
